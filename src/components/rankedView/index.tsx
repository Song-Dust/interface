    ...
    return (
        <div className="flex max-h-fit w-full gap-4">
            <div className="bg-light-gray-2 rounded-xl w-24 flex flex-col justify-center items-center">
                ...
                </div> : <div className="text-xl font-semibold">―</div>}
            </div>
